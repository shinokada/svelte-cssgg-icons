<script>
  ...
  export let ariaLabel = 'play list search';
</script>
...
>
  <path d="M15.8787 4.87866H3.87872V6.87866H15.8787V4.87866Z" fill={color} />
  <path d="M15.8787 8.87866H3.87872V10.8787H15.8787V8.87866Z" fill={color} />
  <path d="M3.87872 12.8787H11.8787V14.8787H3.87872V12.8787Z" fill={color} />
  <path
    fill-rule="evenodd"
    clip-rule="evenodd"
...
@prop export let ariaLabel = 'play list search';
-->
