<script>
  ...
  export let ariaLabel = 'push chevron right r';
</script>
...
>
  <path
    ...
    fill={color}
  />
  <path d="M14.3559 16L14.3559 7.99996H16.3559V16H14.3559Z" fill={color} />
  <path
    fill-rule="evenodd"
    clip-rule="evenodd"
...
@prop export let ariaLabel = 'push chevron right r';
-->
