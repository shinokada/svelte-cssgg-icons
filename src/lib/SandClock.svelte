<script>
  ...
  export let ariaLabel = 'sand clock';
</script>
...
>
  <path d="M13 6H11V7C11 7.55228 11.4477 8 12 8C12.5523 8 13 7.55228 13 7V6Z" fill={color} />
  <path
    fill-rule="evenodd"
    clip-rule="evenodd"
...
@prop export let ariaLabel = 'sand clock';
-->
