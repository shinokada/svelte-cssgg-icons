...
>
  <path
    ...
    fill={color}
  />
  <path d="M5 12C5 8.13401 8.13401 5 12 5V7C9.23858 7 7 9.23858 7 12H5Z" fill={color} />
  <path d="M12 17C14.7614 17 17 14.7614 17 12H19C19 15.866 15.866 19 12 19V17Z" fill={color} />
  <path
    fill-rule="evenodd"
    clip-rule="evenodd"
