<script>
  ...
  export let ariaLabel = 'loadbar doc';
</script>
...
>
  <path
    ...
    fill={color}
  />
  <path d="M8 7H16V9H8V7Z" fill={color} />
  <path d="M8 11H16V13H8V11Z" fill={color} />
  <path d="M8 15H13V17H8V15Z" fill={color} />
</svg>
...
@prop export let ariaLabel = 'loadbar doc';
-->
