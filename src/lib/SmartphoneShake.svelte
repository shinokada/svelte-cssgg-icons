<script>
  ...
  export let ariaLabel = 'smartphone shake';
</script>
...
>
  ...
  <path
    ...
    fill={color}
  />
  <path d="M18 9H20V15H18V9Z" fill={color} />
  <path d="M0 14H2V10H0V14Z" fill={color} />
  <path d="M6 15H4V9H6V15Z" fill={color} />
  <path d="M24 10H22V14H24V10Z" fill={color} />
</svg>
...
@prop export let ariaLabel = 'smartphone shake';
-->
