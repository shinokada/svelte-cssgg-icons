<script>
  ...
  export let ariaLabel = 'arrows shrink v';
</script>
...
>
  <path d="M17 1V3L7 3V1L17 1Z" fill={color} />
  <path
    ...
    fill={color}
  />
  <path d="M17 23V21H7V23H17Z" fill={color} />
</svg>
...
@prop export let ariaLabel = 'arrows shrink v';
-->
