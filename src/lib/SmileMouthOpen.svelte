<script>
  ...
  export let ariaLabel = 'smile mouth open';
</script>
...
>
  <path d="M12 17C14.2091 17 16 15.2091 16 13H8C8 15.2091 9.79086 17 12 17Z" fill={color} />
  <path
...
@prop export let ariaLabel = 'smile mouth open';
-->
