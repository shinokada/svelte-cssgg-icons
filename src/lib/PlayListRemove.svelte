<script>
  ...
  export let size = '24';
  export let role = 'img';
  export let ariaLabel = 'play list remove';
</script>
...
>
  <path d="M15.9644 4.63379H3.96442V6.63379H15.9644V4.63379Z" fill={color} />
  <path d="M15.9644 8.63379H3.96442V10.6338H15.9644V8.63379Z" fill={color} />
  <path d="M3.96442 12.6338H11.9644V14.6338H3.96442V12.6338Z" fill={color} />
  <path
...
@prop export let ariaLabel = 'play list remove';
-->
