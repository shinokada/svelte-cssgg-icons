<script>
  ...
  export let ariaLabel = 'push chevron left r';
</script>
...
>
  <path
    ...
    fill={color}
  />
  <path d="M9.96265 8.00007V16.0001H7.96265V8.00007H9.96265Z" fill={color} />
  <path
    fill-rule="evenodd"
    clip-rule="evenodd"
...
@prop export let ariaLabel = 'push chevron left r';
-->
