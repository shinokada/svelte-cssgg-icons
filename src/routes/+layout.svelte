<script>
  ...
  const title = 'Svelte Cssgg Icons';
...
<MetaTags
  {title}
  description="svelte-cssgg-icons icon set for Svelte"
  openGraph={{
    type: 'website',
    url: 'https://svelte-cssgg-icons.vercel.app/',
    title: 'Svelte Cssgg Icons',
    description: 'Cssgg icon set for Svelte',
    images: [
      {
        url: 'https://open-graph-vercel.vercel.app/api/svelte-cssgg-icons',
        width: 1200,
        height: 630,
        alt: 'Svelte Cssgg Icons'
      }
    ],
    siteName: 'Svelte Cssgg Icons'
  }}
  twitter={{
    handle: '@shinokada',
    ...
    title: 'Svelte Cssgg Icons',
    description: 'Cssgg icon set for Svelte',
    image: 'https://open-graph-vercel.vercel.app/api/svelte-cssgg-icons',
    imageAlt: 'Svelte Cssgg Icons'
  }}
/>

<div class="max-h-screen overflow-auto relative w-full" id="svelte">
  <header
    class="sticky top-0 z-40 flex-none w-full mx-auto bg-white border-b border-gray-200 dark:border-gray-600 dark:bg-zinc-900"
  >
    <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-zinc-900 ">
      <NavBrand href="/">
        <span
